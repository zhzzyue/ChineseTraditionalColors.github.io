...
(function () {
  ...
  function hueToRgb(t1, t2, hue) {
    if (hue < 0) hue += 6;
    if (hue >= 6) hue -= 6;
    if (hue < 1) return (t2 - t1) * hue + t1;else if (hue < 3) return t2;else if (hue < 4) return (t2 - t1) * (4 - hue) + t1;
    return t1;
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__w3cColor__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__w3cColor___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__w3cColor__);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
window.colorRgb = function (sColor, getArr) {
  ...
  if (sColor && reg.test(sColor)) {
    ...
    return getArr ? sColorChange : "RGB(" + sColorChange.join(",") + ")";
  }
  return sColor;
};
